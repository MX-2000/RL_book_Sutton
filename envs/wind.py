...
"""
Credits to https://github.com/vojtamolda/reinforcement-learning-an-introduction/blob/main/chapter06/windy.py
"""
...
class WindyGridworldEnv(gym.Env):
    ...
    def render(self, mode="human"):
        if self.ax is None:
            ...
            self.ax.annotate(
                "G", self.goal, size=25, color="gray", ha="center", va="center"
            )
            self.ax.annotate(
                "S", self.start, size=25, color="gray", ha="center", va="center"
            )
